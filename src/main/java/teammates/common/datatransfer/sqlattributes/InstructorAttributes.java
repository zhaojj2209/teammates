package teammates.common.datatransfer.sqlattributes;
...
public class InstructorAttributes extends EntityAttributes<Instructor> {
    ...
    public static InstructorAttributes valueOf(Instructor instructor) {
        ...
        instructorAttributes.accountId = instructor.getAccountId();
    ...
    public InstructorAttributes getCopy() {
        ...
        instructorAttributes.accountId = accountId;
    ...
    public Instructor toEntity() {
        return new Instructor(accountId, courseId, isArchived, name, email, role,
    ...
    public List<String> getInvalidityInfo() {
        ...
        if (accountId != null) {
            addNonEmptyError(FieldValidator.getInvalidityInfoForGoogleId(accountId), errors);
        }
    ...
    public int hashCode() {
        ...
        stringBuilder.append(this.email).append(this.name).append(this.courseId)
                .append(this.accountId).append(this.displayedName).append(this.role);
    ...
    public boolean equals(Object other) {
        if (other == null) {
            ...
            return Objects.equals(this.email, otherInstructor.email)
                    ...
                    && Objects.equals(this.accountId, otherInstructor.accountId)
    ...
    public void sanitizeForSaving() {
        accountId = SanitizationHelper.sanitizeGoogleId(accountId);
    ...
    public void update(UpdateOptionsWithEmail updateOptions) {
        updateOptions.accountIdOption.ifPresent(s -> accountId = s);
        updateBasic(updateOptions);
    }

    /**
     * Updates with {@link UpdateOptionsWithAccountId}.
     */
    public void update(UpdateOptionsWithAccountId updateOptions) {
    ...
    /**
     * Returns a {@link UpdateOptionsWithAccountId.Builder} to build {@link UpdateOptions}
     * for an instructor with {@code courseId} and {@code accountId}.
     */
    public static UpdateOptionsWithAccountId.Builder updateOptionsWithAccountIdBuilder(String courseId, String accountId) {
        return new UpdateOptionsWithAccountId.Builder(courseId, accountId);
    }
    ...
    public static class UpdateOptionsWithEmail extends UpdateOptions {
        ...
        private UpdateOption<String> accountIdOption = UpdateOption.empty();
        ...
        public String toString() {
            return super.toString()
                    + "]" + String.format("(courseId = %s/email = %s)", courseId, email);
        }
        ...
        public static class Builder extends BasicBuilder<UpdateOptionsWithEmail, UpdateOptionsWithEmail.Builder> {
            ...
            public Builder withAccountId(String accountId) {
                updateOptionsWithEmail.accountIdOption = UpdateOption.of(accountId);
     ...
     */
    public static class UpdateOptionsWithAccountId extends UpdateOptions {
        private String courseId;
        private String accountId;

        private UpdateOption<String> emailOption = UpdateOption.empty();

        private UpdateOptionsWithAccountId(String courseId, String accountId) {
            super();
            assert courseId != null;
            assert accountId != null;
        ...
        public String toString() {
            return super.toString()
                    + ", email = " + emailOption
                    + "]" + String.format("(courseId = %s/accountId = %s)", courseId, accountId);
        }

        /**
         * Builder class for {@link UpdateOptionsWithAccountId}.
         */
        public static class Builder
                extends BasicBuilder<UpdateOptionsWithAccountId, UpdateOptionsWithAccountId.Builder> {

            private UpdateOptionsWithAccountId updateOptionsWithAccountId;

            private Builder(String courseId, String accountId) {
                super(new UpdateOptionsWithAccountId(courseId, accountId));
                thisBuilder = this;

                updateOptionsWithAccountId = (UpdateOptionsWithAccountId) updateOptions;
            }

            public Builder withEmail(String email) {
                assert email != null;

                updateOptionsWithAccountId.emailOption = UpdateOption.of(email);
                return this;
            }

            @Override
            public UpdateOptionsWithAccountId build() {
                return updateOptionsWithAccountId;
            }
        }
    }
    ...
    private abstract static class BasicBuilder<T, B extends BasicBuilder<T, B>> {
        ...
        public B withIsArchived(boolean isArchived) {
            updateOptions.isArchivedOption = UpdateOption.of(isArchived);
            return thisBuilder;
        }
